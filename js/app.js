...
let timelineDias = 60; // NUEVA VARIABLE DINÁMICA
...
function actualizarLogicaNegocio(pos){
    ...
    const total=(estado==="EN PLAZO"||estado==="Aún no instalado")
        ? saldoF1
    ...
    const offsetVenceLocal = (regla.vence >= regla.emision)
        ? (regla.vence - regla.emision)
        : (30 - regla.emision + regla.vence);
